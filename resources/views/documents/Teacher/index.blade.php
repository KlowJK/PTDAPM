                            ...
                            <div class="modal fade" id="updateModal-{{$item->matailieu}}" tabindex="-1" aria-labelledby="updateModalLabel-{{$item->matailieu}}" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('teacher.update', $item->matailieu) }}" class="form" method="POST" enctype="multipart/form-data">
                                                @method('PATCH')
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="matailieu" class="form-label">Mã tài liệu</label>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('teacher.destroy', $item->matailieu) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
