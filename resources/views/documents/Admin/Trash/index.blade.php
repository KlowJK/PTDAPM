...
@section('title')
    <div class="container-fluid">
        <div class="content">
            <h2>Danh sách trang ẩn tin tức</h2>
        </div>
    </div>
        ...
        <table class="table">
            ...
            @foreach($trashDocument as $item)
                ...
                <tr>
                    ...
                    <td>
                        @if ($item->TrangThai)
                            <span class="ant-tag-like ant-tag-like-red">Đang ẩn
                                <i class="bi bi-ban"></i>
                            </span>
                        @else
                    ...
                    <td>
                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#detailModal-{{$item->matailieu}}">Khôi phục<i class="bi bi-arrow-clockwise"></i>
                        </button>
                    </td>
                </tr>
                ...
                <div class="modal fade" id="detailModal-{{$item->matailieu}}" tabindex="-1" aria-labelledby="detailModalLabel-{{$item->matailieu}}" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.trash.update', $item->matailieu) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-danger">Khôi phục<i class="bi bi-arrow-clockwise"></i>
                                    </button>
                                </div>
                            </form>
                        </div>
